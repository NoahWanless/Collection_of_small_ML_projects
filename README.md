################################## INTRO: ##################################
This is a collection of smaller Data Science/ Machine learning projects I have done for both school and personally.
Most (all at the time of writing at least) are jupyter notebooks, and within them contain a overview of what the project goal was.
However here i will also provide a quick overview of all of them.


################################## NOTES: ##################################
Most of these were made with the use of the sklearn python module to create these models
...
Score:
test_set_1: score: 18.568 (Rank 1 in the class)
test_set_2: score: 16.185 (Rank 4 in the class)
...
Data: Take from the following website:
